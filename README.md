...
A lightweight, cross-platform desktop application framework powered by a custom fork of [WRY](https://github.com/nnttoo/wry) in Rust. Think of it as an ultra-minimalist alternative to Electron, designed to build modern desktop UIs using web technologies without the massive file size overhead.
...
- 🕧 Create NPM Package webview_ipc
    ...
    - 🕧 create Builder to deploy Exe File
...
```
your commit message [build v1.0.5]
``